    ...
    def __init__(
        ...
        for i in range(num_layers):
            layer = LSTMAttentionDot(
                input_size, hidden_size, batch_first=self.batch_first
            )
...
class Seq2SeqAttention(nn.Module):
    ...
    def __init__(
        ...
        self.decoder = \
            StackedAttentionLSTM(trg_emb_dim, trg_hidden_dim, nlayers_trg) if self.nlayers_trg > 1 else \
            LSTMAttentionDot(trg_emb_dim, trg_hidden_dim, batch_first=True)
